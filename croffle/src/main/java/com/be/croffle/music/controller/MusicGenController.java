package com.be.croffle.music.controller;
...
import com.be.croffle.music.service.MusicGenService;
...
public class MusicGenController {
    ...
    public ResponseEntity<ApiResponse.CustomBody<MusicGenWithTextResponse>> genMusic(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestBody MusicGenWithTextRequest reqDto){
        MusicGenWithTextResponse response = musicGenService.genMusicUrl(reqDto, userDetails);
    ...
    public ResponseEntity<?> genMusicWithImage(@RequestPart("image") MultipartFile image, @AuthenticationPrincipal UserDetailsImpl userDetails){
        MusicGenWithImageResponse response = musicGenService.genMusicUrlWithImage(image, userDetails);
        //
        return ApiResponseGenerator.success(response, HttpStatus.OK);
    }
